...
app.get('/testing_signup_dragons', function(req, res){
    if (req.headers['x-forwarded-proto'] != 'https'){
        ...
        var query = 'select * from testing_signup where count < 29 and level = -1 order by test_day';
        db.any(query)
            .then(function(rows){
...
app.get('/testing_signup_basic', function(req, res){
    if (req.headers['x-forwarded-proto'] != 'https'){
        ...
        var query = 'select * from testing_signup where count < 29 and level = 0 order by test_day';
        db.any(query)
            .then(function(rows){
...
app.get('/testing_signup_level2', function(req, res){
    if (req.headers['x-forwarded-proto'] != 'https'){
        ...
        var query = 'select * from testing_signup where count < 29 and level = 2 order by test_day';
        db.any(query)
            .then(function(rows){
...
app.get('/testing_signup_level3', function(req, res){
    if (req.headers['x-forwarded-proto'] != 'https'){
        ...
        var query = 'select * from testing_signup where count < 29 and level = 3 order by test_day';
        db.any(query)
            .then(function(rows){
...
app.get('/testing_signup_weapons', function(req, res){
    if (req.headers['x-forwarded-proto'] != 'https'){
        ...
        var query = 'select * from testing_signup where count < 29 and level = 4 order by test_day';
        db.any(query)
            .then(function(rows){
...
app.post('/testing_preview/(:fname)/(:lname)/(:email)/(:belts)/(:month)/(:day)/(:time)/(:belt_group)/(:id_from_other)', function(req, res){
    ...
    if (item.button == 'Edit'){
        if (req.params.belt_group == -1){
            var query = 'select * from testing_signup where count < 29 and level = -1';
            db.any(query)
                .then(function(rows){
                    res.render('store/testing_signup_dragons', {
                        fname: item.fname,
        ...
        if (req.params.belt_group == 0){
            var query = 'select * from testing_signup where count < 29 and level = 0';
            db.any(query)
                .then(function(rows){
                    res.render('store/testing_signup_basic', {
                        fname: item.fname,
        ...
        if (req.params.belt_group == 2){
            var query = 'select * from testing_signup where count < 29 and level = 2';
            db.any(query)
                .then(function(rows){
                    res.render('store/testing_signup_level2', {
                        fname: item.fname,
        ...
        if (req.params.belt_group == 3){
            var query = 'select * from testing_signup where count < 29 and level = 3';
            db.any(query)
                .then(function(rows){
                    res.render('store/testing_signup_level3', {
                        fname: item.fname,
        ...
        if (req.params.belt_group == 4){
            var query = 'select * from testing_signup where count < 29 and level = 4';
            db.any(query)
                .then(function(rows){
                    res.render('store/testing_signup_weapons', {
                        fname: item.fname,
...
app.get('/2degree_signup', function(req, res){
    if (req.headers['x-forwarded-proto'] != 'https'){
        ...
        var query = "select TO_CHAR(date_order, 'Month') as month_name, TO_CHAR(date_order, 'DD') as day_number, time_num, level, id, count from class_times where level in (10, 10.5) and count < 29 and date_order >= (CURRENT_DATE - INTERVAL '1 day')::date order by date_order;";
        db.any(query)
            .then(function(rows){
                if (rows.length == 0){
...
app.get('/1degree_signup', function(req, res){
    if (req.headers['x-forwarded-proto'] != 'https'){
        ...
        var query = "select TO_CHAR(date_order, 'Month') as month_name, TO_CHAR(date_order, 'DD') as day_number, time_num, id, count from class_times where level in (4) and count < 30 and date_order >= (CURRENT_DATE - INTERVAL '1 day')::date order by date_order;";
        db.any(query)
            .then(function(rows){
                if (rows.length == 0){
                    res.render('store/temp_classes', {
...
app.get('/dragons_signup', function(req, res){
    if (req.headers['x-forwarded-proto'] != 'https'){
        ...
        var query = "select TO_CHAR(date_order, 'Month') as month_name, TO_CHAR(date_order, 'DD') as day_number, time_num, id, count from class_times where level in (0) and count < 30 and date_order >= (CURRENT_DATE - INTERVAL '1 day')::date order by date_order;";
        db.any(query)
            .then(function(rows){
                if (rows.length == 0){
                    res.render('store/temp_classes', {
...
app.get('/basic_signup', function(req, res){
    if (req.headers['x-forwarded-proto'] != 'https'){
        ...
        var query = "select TO_CHAR(date_order, 'Month') as month_name, TO_CHAR(date_order, 'DD') as day_number, time_num, level, id, count from class_times where level in (0.5, 0.8) and count < 30 and date_order >= (CURRENT_DATE - INTERVAL '1 day')::date order by date_order;";
        db.any(query)
            .then(function(rows){
                if (rows.length == 0){
                    res.render('store/temp_classes', {
...
app.get('/level1_signup', function(req, res){
    if (req.headers['x-forwarded-proto'] != 'https'){
        ...
        var query = "select TO_CHAR(date_order, 'Month') as month_name, TO_CHAR(date_order, 'DD') as day_number, time_num, level, id, count from class_times where level in (1, 1.5) and count < 30 and date_order >= (CURRENT_DATE - INTERVAL '1 day')::date order by date_order;";
        db.any(query)
            .then(function(rows){
                if (rows.length == 0){
                    res.render('store/temp_classes', {
...
app.get('/level2_signup', function(req, res){
    if (req.headers['x-forwarded-proto'] != 'https'){
        ...
        var query = "select TO_CHAR(date_order, 'Month') as month_name, TO_CHAR(date_order, 'DD') as day_number, time_num, id, count from class_times where level in (2) and count < 30 and date_order >= (CURRENT_DATE - INTERVAL '1 day')::date order by date_order;";
        db.any(query)
            .then(function(rows){
                if (rows.length == 0){
                    res.render('store/temp_classes', {
...
app.get('/level3_signup', function(req, res){
    if (req.headers['x-forwarded-proto'] != 'https'){
        ...
        var query = "select TO_CHAR(date_order, 'Month') as month_name, TO_CHAR(date_order, 'DD') as day_number, time_num, id, count from class_times where level in (3) and count < 30 and date_order >= (CURRENT_DATE - INTERVAL '1 day')::date order by date_order;";
        db.any(query)
            .then(function(rows){
                if (rows.length == 0){
                    res.render('store/temp_classes', {
...
app.get('/prep_signup', function(req, res){
    if (req.headers['x-forwarded-proto'] != 'https'){
        ...
        var query = "select TO_CHAR(date_order, 'Month') as month_name, TO_CHAR(date_order, 'DD') as day_number, time_num, id, count from class_times where level in (3.5) and count < 30 and date_order >= (CURRENT_DATE - INTERVAL '1 day')::date order by date_order;";
        db.any(query)
            .then(function(rows){
                if (rows.length == 0){
                    res.render('store/temp_classes', {
...
app.get('/weapons_signup', function(req, res){
    if (req.headers['x-forwarded-proto'] != 'https'){
        ...
        var query = "select TO_CHAR(date_order, 'Month') as month_name, TO_CHAR(date_order, 'DD') as day_number, time_num, id, count from class_times where level in (6) and count < 30 and date_order >= (CURRENT_DATE - INTERVAL '1 day')::date order by date_order;";
        db.any(query)
            .then(function(rows){
                if (rows.length == 0){
                    res.render('store/temp_classes', {
...
app.get('/open_mat_signup', function(req, res){
    if (req.headers['x-forwarded-proto'] != 'https'){
        ...
        var query = "select TO_CHAR(date_order, 'Month') as month_name, TO_CHAR(date_order, 'DD') as day_number, time_num, id, count from class_times where level in (7) and count < 30 and date_order >= (CURRENT_DATE - INTERVAL '1 day')::date order by date_order;";
        db.any(query)
            .then(function(rows){
                if (rows.length == 0){
                    res.render('store/temp_classes', {
...
app.post('/class_preview/(:fname)/(:lname)/(:email)/(:belt_group)/(:month)/(:day)/(:time)/(:other_id)', function(req, res){
    ...
    if (item.button == 'Edit'){
        if (req.params.belt_group == 'Black Belt'){
            var query = "select * from class_times where count < 30 and level = 4 and date_order >= (CURRENT_DATE - INTERVAL '1 day')::date order by date_order";
            db.any(query)
                .then(function(rows){
                    res.render('store/1degree_signup', {
                        fname: item.fname,
        ...
        if (req.params.belt_group == 'Little Dragons'){
            var query = "select * from class_times where count < 30  and level = 0 and date_order >= (CURRENT_DATE - INTERVAL '1 day')::date order by date_order";
            db.any(query)
                .then(function(rows){
                    res.render('store/dragons_signup', {
                        fname: item.fname,
        ...
        if (req.params.belt_group == 'Basic'){
            var query = "select * from class_times where count < 30 and level = 0.5 and date_order >= (CURRENT_DATE - INTERVAL '1 day')::date order by date_order";
            db.any(query)
                .then(function(rows){
                    res.render('store/basic_signup', {
                        fname: item.fname,
        ...
        if (req.params.belt_group == 'Level 1'){
            var query = "select * from class_times where count < 30 and level = 1 and date_order >= (CURRENT_DATE - INTERVAL '1 day')::date order by date_order";
            db.any(query)
                .then(function(rows){
                    res.render('store/level1_signup', {
                        fname: item.fname,
        ...
        if (req.params.belt_group == 'Level 2'){
            var query = "select * from class_times where count < 30 and level = 2 and date_order >= (CURRENT_DATE - INTERVAL '1 day')::date order by date_order";
            db.any(query)
                .then(function(rows){
                    res.render('store/level2_signup', {
                        fname: item.fname,
        ...
        if (req.params.belt_group == 'Prep Cycle'){
            var query = "select * from class_times where count < 30 and level = 3.5 and date_order >= (CURRENT_DATE - INTERVAL '1 day')::date order by date_order";
            db.any(query)
                .then(function(rows){
                    res.render('store/prep_signup', {
                        fname: item.fname,
        ...
        if (req.params.belt_group == 'Weapons'){
            var query = "select * from class_times where count < 30 and level = 6 and date_order >= (CURRENT_DATE - INTERVAL '1 day')::date order by date_order";
            db.any(query)
                .then(function(rows){
                    res.render('store/open_mat_signup', {
                        fname: item.fname,
...
app.get('/board_breaking', function(req, res){
    const query = 'select * from board_breaking_times where count < 26 order by class_day';
    db.any(query)
        .then(function(rows){
...
app.get('/class_checkin/(:id)/(:date_selected)/(:level_num)/(:time_num)', (req, res) => {
    ...
    let student_find_query = "select A.first_name, A.last_name, A.is_swat, B.swat_count from class_signups A, class_times B where A.id_from_other = $1 and B.id = $1 order by A.last_name;";
